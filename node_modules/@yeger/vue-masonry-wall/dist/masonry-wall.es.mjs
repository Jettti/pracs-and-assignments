...
const F = ["data-index"], L = /* @__PURE__ */ M({
  ...
  setup(a, { emit: p }) {
    ...
    async function m(e = !1) {
      ...
      await k(0), l ? l.scrollBy({ top: t - l.scrollTop }) : window.scrollTo({ top: t }), p("redraw");
    }
    const o = typeof ResizeObserver > "u" ? void 0 : new ResizeObserver(() => m());
    return $(() => {
      m(), o == null || o.observe(c.value);
    }), D(() => o == null ? void 0 : o.unobserve(c.value)), B([s, h], () => m(!0)), B([g, r], () => m()), (e, l) => (d(), f("div", {
      ref_key: "wall",
      ref: c,
      class: "masonry-wall",
